            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pb-4 animate-fadeIn">
                ...
                >
                    ...
                    <div className="p-4 flex flex-col justify-center items-start">
                        ...
                        <p className="text-gray-300 text-sm mb-3">
                            Ultra-fast job queue written in C.
                        </p>
                ...
                >
                    ...
                    {/* RIGHT CONTENT */}
                    <div className="p-4 flex flex-col justify-center items-start">
                        <h3 className="font-semibold text-xl mb-1">HexaPic</h3>
                        <p className="text-gray-300 text-sm mb-3">
                ...
                >
                    ...
                    <div className="p-4 flex flex-col justify-center">
                        <h3 className="font-semibold text-xl mb-1">HexaMove</h3>
                        <p className="text-gray-300 text-sm mb-3">
                            Play the Tic-Tak game online !
                        </p>
                        <div className="flex flex-wrap gap-2">
                            <span className="px-3 py-1 rounded-full text-sm bg-gradient-to-br from-purple-600/30 to-pink-600/30 border border-white/10 shadow-[0_0_10px_rgba(255,0,255,0.25)]">
                                TypeScript
                ...
                >
                    ...
                    <div className="p-4 flex flex-col justify-center">
                        <h3 className="font-semibold text-xl mb-1">Portfolio</h3>
                        <p className="text-gray-300 text-sm mb-3">
                            My portfolio website built with React and TypeScript.
                        </p>
                        <div className="flex flex-wrap gap-2">
                            <span className="px-3 py-1 rounded-full text-sm bg-gradient-to-br from-purple-600/30 to-pink-600/30 border border-white/10 shadow-[0_0_10px_rgba(255,0,255,0.25)]">
                                TypeScript
                ...
                >
                    ...
                    <div className="p-4 flex flex-col justify-center">
                        <h3 className="font-semibold text-xl mb-1">Clash Not Royal</h3>
                        <p className="text-gray-300 text-sm mb-3">
                            Simple game to learn how to use MongoDB
                        </p>
                        <div className="flex flex-wrap gap-2">
                            <span className="px-3 py-1 rounded-full text-sm bg-gradient-to-br from-purple-600/30 to-pink-600/30 border border-white/10 shadow-[0_0_10px_rgba(255,0,255,0.25)]">
                                Python
